				  ...
				  <br><br><br>
					<form action="php/contact.php" method="POST">
						<input type="text" name="name" placeholder="Your name" required=""><br><br>
                          <input type="text" name="contact" placeholder="Your Contact Number" required=""><br><br>
                          <input type="email" name="email" placeholder="Your Email" required=""><br><br>
                          <textarea rows="10" cols="24" name="message" placeholder="Your Message" required=""></textarea><br>
						<br><br>
						<input class="btn btn-lg animation animated-item-3" type="submit" value="Submit">
					</form>
				  <br><br><br>
				</div>
			</div>
