        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
					...
					&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a class="btn btn-md animation animated-item-3" href="log.php">Login</a>
                </ul>
            </div>
        </div>
    </header><!--/header-->
						...
						<div class="col-md-6">
						  <br><br><br>
							<form action="php/signup.php" method="POST">
								...
								<input type="password" name="confpassword" placeholder="Conform Password"><br>
								<br><br>
								<input class="btn btn-lg animation animated-item-3" type="submit" value="Sign Up">
							</form>
						  <br><br><br>
						</div>
					</div>
